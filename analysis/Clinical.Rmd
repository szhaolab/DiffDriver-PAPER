...
```{r include-pdf-figure, out.width='85%', fig.cap="A caption for your PDF figure."}
...
```{r include-pdf-figure2, out.width='85%', fig.cap="A caption for your PDF figure."}
...
```{r out.width='85%', fig.cap="A caption for your PDF figure."}
