...
![Barplot of GO enrichment (age)](material/barplot-GO-bio-age.png)

```{r include-png-figure, out.width='85%', fig.cap="Barplot of GO enrichment (age)"}
knitr::include_graphics("material/barplot-GO-bio-age.png")
```
...
knitr::include_graphics("material/barplot-GO-bio-tmb.png")
```
...
knitr::include_graphics("material/barplot-GO-bio-ins.png")
```
