...
knitr::include_graphics("output/barplot-GO-bio-age.png")
```
...
knitr::include_graphics("output/barplot-GO-bio-tmb.png")
```
...
knitr::include_graphics("output/barplot-GO-bio-ins.png")
```
