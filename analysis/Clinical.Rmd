...
These failed analyses were subsequently rerun after excluding gender as a covariate. For the **5** phenotypes other than Diagnosis Age, only **age** was included as a **covariate**. For **Diagnosis Age**, **no covariates** were included because age was the phenotype itself and gender had no variation within these tumor types.
...
```{r}
immune_sig <- read.csv("output/Immune Subtypes.csv")
...
clinical_data_dir <- "/dartfs/rc/lab/S/Szhao/diffDriver/data_clinical/cbioportal_download"
...
knitr::include_graphics("docs/material/barplot-GO-bio-age.png", error = FALSE)
```
...
knitr::include_graphics("material/barplot-GO-bio-tmb.png", error = FALSE)
```
...
knitr::include_graphics("material/barplot-GO-bio-ins.png", error = FALSE)
```
